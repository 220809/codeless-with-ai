package com.dingzk.codeless.ratelimit.aspect;
...
public class RateLimitAspect {
    ...
    public void doLimitRate(JoinPoint joinPoint, RateLimit rateLimit) {
        ...
        rateLimiter.trySetRate(RateType.OVERALL, rateLimit.rate(), Duration.ofMinutes(rateLimit.rateInterval()));
        // 尝试获取令牌，如果获取失败则限流
